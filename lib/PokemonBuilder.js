...
const RocketMultiplierTable = require('./RocketMultiplierTable');
...
module.exports = {
    ...
    calculateRocketCP(pokemon, rank=1) {
        const base = PokemonData[pokemon.pokedexId];
        const rCPM = RocketMultiplierTable[pokemon.level];
        ...
        console.log(pokemon.level, rCPM, attack, defense, hp)
